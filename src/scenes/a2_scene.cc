...
Scene *A2Scene(int sx, int sy) {
  ...
  for (int i = 0; i < 13; i++) {
    if (i % 5 == 0) { s = new TangleCube(new Lambertian(Colour(1, .25, .25)));}
    if (i % 5 == 1) { s = new Torus(new Lambertian(Colour(1, .25, .25)));}
    if (i % 5 == 2) { s = new Tetrahedral(new Lambertian(Colour(1, .25, .25)));}
    if (i % 5 == 3) { s = new Chubbs(new Lambertian(Colour(1, .25, .25))); s->Scale(2,2,2);}
    if (i % 5 == 4) { s = new Sweet(new Lambertian(Colour(1, .25, .25))); s->Scale(2.5,2.5,2.5);}
  ...
  for (int i = 0; i < 13; i++) {
    if (i % 4 == 0) s = new Sphere(new Lambertian(Colour(1, .25, .25)));
    if (i % 4 == 1) s = new Cylinder(new Lambertian(Colour(1, .25, .25)));
    if (i % 4 == 2) s = new Plane(new Lambertian(Colour(1, .25, .25)));
    if (i % 4 == 3) s = new Disc(new Lambertian(Colour(1, .25, .25)));
  ...
  for (int i = 0; i < 13; i++) {
    s = new Cube(new Lambertian(Colour(1, .25, .25)));
    s->Scale(0.4, 0.4, 0.4);
    // s->Scale(1.5, .75, .75);
    s->RotateZ(rand01() * 2 * PI);
    s->RotateX(rand01() * 2 * PI);
  ...
  for (int i = 0; i < 500000; i++) {
    s = new Sphere(new Lambertian(Colour(0.75, 0.95, 0.55)));
    s->Scale(.05, .05, .05);
    s->RotateZ(-PI / 1.5);
